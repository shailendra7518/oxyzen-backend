  ...
  <header className="bg-white  p-4 relative z-10 ">
    <div className="container mx-auto flex  items-center justify-center gap-4 border-2 border-gray-300 rounded-md">
      <div className="flex items-center flex-wrap">
        ...
        <div className="flex items-center border-l-2 border-gray-300 pl-2">
...
const Header: React.FC = () => {
  ...
  return (
    <>
      <div className="flex flex-1  w-full bg-bgCardWhite items-center content-center justify-between p-5 shadow-sm text-textNavLinkNormal max-w-screen-xl">
